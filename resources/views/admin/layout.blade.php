...
{{--                    <a class="navbar-brand" href="./"><img src="{{ asset('admin_resources/img/logo.svg') }}" alt="Logo"></a>--}}
{{--                    <a class="navbar-brand hidden" href="./"><img src="{{ asset('admin_resources/img/logo.svg') }}" alt="Logo"></a>--}}
{{--                    <a id="menuToggle" class="menutoggle"><i class="fa fa-bars"></i></a>--}}
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="{{ asset('admin_resources/img/admin.png')  }}" alt="User">
                        </a>
    ...
    <script src="{{ asset('admin_resources/js/init/fullcalendar-init.js') }}"></script>
</body>
</html>
